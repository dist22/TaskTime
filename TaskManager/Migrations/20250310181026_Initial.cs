    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskTimeUser", x => new { x.TasksTaskId, x.UsersUserId });
                    table.ForeignKey(
                        name: "FK_TaskTimeUser_Tasks_TasksTaskId",
                        column: x => x.TasksTaskId,
                        principalTable: "Tasks",
                        principalColumn: "TaskId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskTimeUser_Users_UsersUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskTimeUser_UsersUserId",
                table: "TaskTimeUser",
                column: "UsersUserId");
        }
